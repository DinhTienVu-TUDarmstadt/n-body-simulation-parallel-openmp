...
public:
    ...
    static void get_relevant_nodes_recursive(Universe& universe, QuadtreeNode* node, std::vector<QuadtreeNode*>& relevant_nodes, Vector2d<double>& body_position, std::int32_t body_index, double threshold_theta);
};